        ...
        return [
            ...
            'initiatedAmount' =>
                isset($response['initiatedAmount'])
                    ? (string) $response['initiatedAmount']
                    : null,

            'paymentAmount' =>
                isset($response['paymentAmount'])
                    ? (string) $response['paymentAmount']
                    : null,

            'feeAmount' =>
                isset($response['feeAmount'])
                    ? (string) $response['feeAmount']
                    : null,
            ...
            'customerReference' =>
                isset($response['customerReference'])
                    ? (string) $response['customerReference']
                    : null,
